...
## [Features]
_1._ Visiters will get all latest information related to `covid-counts`.__________________
_2._ Visiters can also get the `counts` for thier country by selecting country name from dropdown.__________
