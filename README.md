...
## [Features]
1. Visiters can access all latest information related to `covid-counts`.
2. Visiters can also access the number of `counts` for thier country by selecting country's name from dropdown menu.
