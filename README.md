...
## [Features]
1. Visiter will get all latest information related to `covid-counts`.
2. Visiter can also get the `counts` for thier country by selecting country name from dropdown.
