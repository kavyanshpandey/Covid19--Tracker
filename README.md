...
## [Features]
1._ Visiters will get all latest information related to `covid-counts`.
2._ Visiters can also get the `counts` for thier country by selecting
    country name from dropdown.
