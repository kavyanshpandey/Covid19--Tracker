...
Almost every corner of the world is affected by this disease.
...
## [Features]
1. Visiters will get all the latest information related to `covid-counts`.
2. Visiters can also get the `counts` for thier country by selecting country name from the dropdown.
