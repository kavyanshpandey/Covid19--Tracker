...
## [Features]
- Visitors will get all latest information related to `covid-counts`.
- Visitors can also get the `counts` for thier country by selecting country name from dropdown.
